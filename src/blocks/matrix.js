...
const PIXEL_SIZE = 15;
const FILLED_PIXEL_COLOR = '#ffffff';
const EMPTY_PIXEL_COLOR = '#000000';
const EMPTY_PIXEL_COLOR_EDITOR = '#222222';
 ...
 */
export class MatrixBitmap extends Blockly.Field {
    /**
    ...
    constructor(value = undefined, validator = undefined, config = undefined) {
        ...
        // current color and color array
        this.currentColor_ = FILLED_PIXEL_COLOR
        this.pixColors_ = new Array(DEFAULT_HEIGHT * DEFAULT_WIDTH)
        for (let i = 0; i < this.pixColors_.length; i++) {
            this.pixColors_[i] = EMPTY_PIXEL_COLOR
        }
    ...
    /**
     * Constructs a MatrixBitmap from a JSON arg object.
     * @param {!Object} options A JSON object with options.
     * @returns {!MatrixBitmap} The new field instance.
     * @package
     * @nocollapse
     */
    ...
    /**
     * set current color: string like "#123456"
     */
    ...
    render_() {
        ...
        if (this.blockDisplayPixels_) {
            this.forAllCells_((r, c) => {
                ...
                const color = this.pixColors_[r * DEFAULT_WIDTH + c]
                console.log("Color:",color)

                if (this.blockDisplayPixels_) {
                    this.blockDisplayPixels_[r][c].style.fill = pixel
                        ? color // FILLED_PIXEL_COLOR
                        : EMPTY_PIXEL_COLOR_EDITOR;
                }
    ...
    setPixel_(r, c, newValue) {
        ...
        // also set pixel colors
        this.pixColors_[r * DEFAULT_WIDTH + c] = newValue ? this.currentColor_ : EMPTY_PIXEL_COLOR
...
Blockly.fieldRegistry.register('matrix_bitmap', MatrixBitmap);
